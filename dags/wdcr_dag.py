...
dag = DAG("wdcr", default_args=default_args, catchup=False)
...
with dag:
    ...
    load_to_hdfs_raw_zone = PythonOperator(
        ...
        op_kwargs={'directory': '/raw/index_dashboard/Global/WDCR'},
    )

    load_to_hdfs_processed_zone = PythonOperator(
        task_id='load_to_hdfs_processed_zone',
        python_callable=store_to_hdfs,
        op_kwargs={'directory': '/processed/index_dashboard/Global/WDCR'},
    )
