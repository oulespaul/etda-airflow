...
class DAI():
    ...
    def __init__(self):
        ...
        self._airflow_path_output = "/opt/airflow/dags/output/dai"
...
def store_to_hdfs(**kwargs):
    ...
    path = "/opt/airflow/dags/output/dai"
...
with dag:
    ...
    load_to_hdfs_raw_zone = PythonOperator(
        ...
        op_kwargs={'directory': '/data/raw/index_dashboard/Global/DAI'},
    )

    load_to_hdfs_processed_zone = PythonOperator(
        task_id='load_to_hdfs_processed_zone',
        python_callable=store_to_hdfs,
        op_kwargs={'directory': '/data/processed/index_dashboard/Global/DAI'},
    )

    clean_up_output = BashOperator(
        task_id='clean_up_output',
        bash_command='rm -f /opt/airflow/dags/output/dai/*.csv && rm -f /opt/airflow/dags/data_source/dai/tmp/raw/*',
    )
